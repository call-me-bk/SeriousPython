...
characters = "_ abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ.',?!@1234567890"
def makeList():
...
def mutate(mylist):
    ...
    return newlist
random.seed();bestList = makeList();bestScore = score(bestList)
guesses = 0;improvements = 0
while True:
